Engine.define('DomComponents', (function () {
    ...
    DomComponents.doModal = function (element) {
        var transportable = {
            mouseX: 0,
            mouseY: 0,
            offsetX: 0,
        ...
        element.addEventListener('dragstart', function (e) {
            DomComponents.handleDragStart(e, element, transportable)
        }, false);
        element.addEventListener('dragenter', function (e) {
            DomComponents.handleDragEnter(e, element)
        }, false);
        element.addEventListener('dragover', function (e) {
            DomComponents.handleDragOver(e)
        }, false);
        element.addEventListener('dragleave', function (e) {
            DomComponents.handleDragLeave(e, element)
        }, false);
        element.addEventListener('drop', function (e) {
            DomComponents.handleDrop(e)
        }, false);
        element.addEventListener('dragend', function (e) {
            DomComponents.handleDragEnd(e, element, transportable)
        }, false);
    };

    DomComponents.handleDragEnd = function (e, element, transportable) {
    ...
    DomComponents.handleDrop = function (e) {
    ...
    DomComponents.handleDragStart = function (e, element, transportable) {
     ...
     * @returns {boolean}
     */
    DomComponents.handleDragOver = function (e/*, transportable*/) {
        if (e.preventDefault) {
    ...
    DomComponents.handleDragEnter = function (e, element) {
        Dom.addClass(element, 'over');
    };

    DomComponents.handleDragLeave = function (e, element) {
        Dom.addClass(element, 'over');
    };
